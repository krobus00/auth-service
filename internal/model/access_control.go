//go:generate mockgen -destination=mock/mock_access_control_repository.go -package=mock github.com/krobus00/auth-service/internal/model AccessControlRepository
package model
