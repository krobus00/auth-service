...
var file_pb_auth_auth_service_proto_rawDesc = []byte{
	...
	,
}

var file_pb_auth_auth_service_proto_goTypes = []interface{}{
	(*AuthRequest)(nil),        // 0: pb.auth.AuthRequest
	(*HasAccessRequest)(nil),   // 1: pb.auth.HasAccessRequest
	(*User)(nil),               // 2: pb.auth.User
	(*wrappers.BoolValue)(nil), // 3: google.protobuf.BoolValue
}
var file_pb_auth_auth_service_proto_depIdxs = []int32{
	0, // 0: pb.auth.AuthService.GetUserInfo:input_type -> pb.auth.AuthRequest
	1, // 1: pb.auth.AuthService.HasAccess:input_type -> pb.auth.HasAccessRequest
	2, // 2: pb.auth.AuthService.GetUserInfo:output_type -> pb.auth.User
	3, // 3: pb.auth.AuthService.HasAccess:output_type -> google.protobuf.BoolValue
